...
local blips = {
 ...
 --   {name="Hospital", id=61, x = -449.67, y = -340.83, z = 33.50, color = 2, heading=82.17, scale=1.0 },
    ...
    {name="Hospital", id=61, x = 305.70138549805, y = -597.62774658203, z = 43.290841369629, color= 2, heading=75.49, scale=1.0},
...
while not HasModelLoaded(hash) do 
    ...
    local npc = CreatePed(6,hash, item.x, item.y, item.z -0.95, item.heading, false, false)
