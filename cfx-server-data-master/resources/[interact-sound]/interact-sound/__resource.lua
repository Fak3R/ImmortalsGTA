...
files({
	...
	'client/html/sounds/car_repair.ogg',
...
'client/html/sounds/sonidoregistro.ogg', -- SONIDO AL HACER CLICK SE REGISTRAN
	'client/html/sounds/clicktablet3.ogg',
	'client/html/sounds/clicktablet2.ogg',
	'client/html/sounds/clicktablet1.ogg',

	'client/html/sounds/Uncuff.ogg', --SONIDO ESPOSAR
	'client/html/sounds/Cuff.ogg',  -- SONIDO DESESPOSAR

	'client/html/sounds/repararauto.ogg', -- SONIDO DE REPARAR
