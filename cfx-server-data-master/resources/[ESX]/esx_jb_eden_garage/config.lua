...
Config.Garages = {
	...
	Garage_Paleto = {	
		...
		Garage_Aviones = {	
		Pos = {x=-1647.68, y=-3153.16, z=13.99},
		Size  = {x = 3.0, y = 3.0, z = 1.0},
		Color = {r = 204, g = 204, b = 0},
		Marker = 1,
		SpawnPoint = {
		...
		DeletePoint = {
			Pos = {x=-1662.9, y=-3143.0, z=13.99},
			Color = {r=255,g=0,b=0},
			Size  = {x = 3.0, y = 3.0, z = 1.0},
			Marker = 1
		},
		MunicipalPoundPoint = {
			Pos = {x=-1292.46, y=-3356.08, z=13.94},
			Color = {r=25,g=25,b=112},
			Size  = {x = 3.0, y = 3.0, z = 1.0},
			Marker = 1
		},	
		SpawnMunicipalPoundPoint = {
			Pos = {x=-1275.15, y=-3386.37, z=13.94},
			Color = {r=0,g=255,b=0},
			Size  = {x = 3.0, y = 3.0, z = 1.0},
			Marker = 1
		},
	...
	Garage_SandyShore = {	
		Pos = {x = 1962.01,y = 3771.56,z = 30.47 },
		Size  = {x = 3.0, y = 3.0, z = 1.0},
		Color = {r = 204, g = 204, b = 0},
		Marker = 1,
		SpawnPoint = {
			Pos = {x = 1949.95,y = 3767.37,z = 30.47 },
			Color = {r=0,g=255,b=0},
			Size  = {x = 3.0, y = 3.0, z = 1.0},
			Marker = 1
		},
