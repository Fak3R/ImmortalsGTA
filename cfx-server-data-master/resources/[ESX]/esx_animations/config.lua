...
Config.Animations = {

	{
		...
		items = {
			...
			{label = "Vomito en coche", type = "anim", data = {lib = "oddjobs@taxi@tie", anim = "vomit_outside"}},
		}
	},
...

	{
		...
		items = {
			...
			{label = "Police : investigar", type = "anim", data = {lib = "amb@code_human_police_investigate@idle_b", anim = "idle_f"}},
			{label = "Police : hablar en la radio", type = "anim", data = {lib = "random@arrests", anim = "generic_radio_chatter"}},
			{label = "Police : tráfico", type = "scenario", data = {anim = "WORLD_HUMAN_CAR_PARK_ATTENDANT"}},
			{label = "Police : binoculares", type = "scenario", data = {anim = "WORLD_HUMAN_BINOCULARS"}},
			...
			{label = "medico : observer", type = "scenario", data = {anim = "CODE_HUMAN_MEDIC_KNEEL"}},
			...
			{label = "tendero : dar la cuenta", type = "anim", data = {lib = "mp_am_hold_up", anim = "purchase_beerbox_shopkeeper"}},
			{label = "Barman : servir un shot", type = "anim", data = {lib = "mini@drinking", anim = "shots_barman_b"}},
			{label = "Periodista : Tomar una fotografia", type = "scenario", data = {anim = "WORLD_HUMAN_PAPARAZZI"}},
			...
			{label = "Vagabundo : Hacer la ronda", type = "scenario", data = {anim = "WORLD_HUMAN_BUM_FREEWAY"}},
...

	{
		...
		items = {
			...
			{label = "gran", type = "anim", data = {lib = "mp_action", anim = "thanks_male_06"}},
			...
			{label = "Lo sabía, putain", type = "anim", data = {lib = "anim@am_hold_up@male", anim = "shoplift_high"}},
...

	{
		...
		label = 'Deportes',
		items = {
			{label = "Mostrar sus musculos", type = "anim", data = {lib = "amb@world_human_muscle_flex@arms_at_side@base", anim = "base"}},
...

	{
		...
		items = {
			...
			{label = "Demasiado come", type = "attitude", data = {lib = "move_m@fat@a", anim = "move_m@fat@a"}},
			...
			{label = "Obrero temporal", type = "attitude", data = {lib = "move_m@hobo@a", anim = "move_m@hobo@a"}},
			...
			{label = "Sombria", type = "attitude", data = {lib = "move_m@shadyped@a", anim = "move_m@shadyped@a"}},
	...
	},
	{
		...
		label = '+18',
		items = {
			{label = "Hombre que se hace follar en coche", type = "anim", data = {lib = "oddjobs@towing", anim = "m_blow_job_loop"}},
