...
Config.Vehicles = {
	{model = 'seashark', label = 'Seashark (Random Color)', price = 20000},
	{model = 'seashark3', label = 'Seashark (Dark Blue)', price = 30000},
	{model = 'suntrap', label = 'Suntrap', price = 60000},
	{model = 'jetmax', label = 'Jetmax', price = 90000},
	{model = 'tropic2', label = 'Tropic', price = 100000},
	{model = 'dinghy2', label = 'Dinghy (Black)', price = 150000},
	{model = 'dinghy', label = 'Dinghy 2 (Random Color)', price = 160000},
	{model = 'speeder', label = 'Speeder', price = 180000},
	{model = 'squalo', label = 'Squalo (Random Color)', price = 190000},
