...
Banks = {
	["fleeca"] = {
		...
		reward = math.random(20000,150000), -- the random range of amount of money you will get for robbery this site
	...
	["blainecounty"] = {
		...
		hackposition = { ['x'] = -105.47, ['y'] = 6471.03, ['z'] = 31.63 },
		reward = math.random(15000,25000),
	...
	["PrincipalBank"] = {
		...
		reward = math.random(5000000,8000000),
