Locales['en'] = {
  ['not_in_whitelist'] = 'Este server esta usando la whitelist. info?, unetenos : %s',
  ['missing_steam_id'] = 'Activado para encontrar tu steamID',
  ['banned_from_server'] = 'You are banned from this server',
  ['waiting_queue_message'] = 'Estas en la cola (%i/%i)',
  ['waiting_free_priority_slots'] = 'Esperando por un slot de prioridad (%i ppriority slots, estimated waiting %im %is)',
  ...
  ['reload_whitelist'] = 'Recargando whitelist',
  ['whitelist_reloaded'] = 'Recarga exitosa whitelist'
}