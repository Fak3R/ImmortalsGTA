...
Config.CircleZones = {
	WeedField = {coords = vector3(2826.21, -746.51, 1.2)}, 
 ...
 --name = _U('blip_weedfield')}, --color = 25, sprite = 496, radius = 100.0},

 --name = _U('blip_weedprocessing')}, --color = 25, sprite = 496, radius = 100.0},