...
Config.DamageMult = 0.000001 -- Higher Number = Higher Repair Price.
...
Config.mafiaPoundPrice    = 500 -- mafia1 Pound Price.
Config.mafia1PoundPrice    = 500 -- mafia1 Pound Price.
Config.mafia2PoundPrice    = 500 -- mafia1 Pound Price.
Config.mafia3PoundPrice    = 500 -- mafia1 Pound Price.
Config.mafia6PoundPrice    = 500 -- mafia1 Pound Price.
Config.mafia5PoundPrice    = 500 -- mafia1 Pound Price.
...
Config.DeleteMarker = {
	...
	x = 7.0, y = 7.0, z = 1.0  -- Big Size Circle
}
...
Config.mafiaPounds = {
	Pound_mafiacasa = {
		PoundPoint = { x = -811.73, y = 157.05, z = 70.40 },
		SpawnPoint = { x = -822.32, y = 157.74, z = 69.20, h = 83.54 }
	},
	Pound_garageheights = {
		PoundPoint = { x = -945.95, y = -2958.02, z = 13.00 },
		SpawnPoint = { x = -951.66, y = -2966.89, z = 12.99, h = 151.40 }
	},
	Pound_garagerojoarriba = {
		PoundPoint = { x = -904.00, y = -144.03, z = 40.88 },
		SpawnPoint = { x = -924.98, y = -170.92, z = 40.98, h = 30.85 }
	},
	Pound_garagecentral = {
		PoundPoint = { x = 237.27, y = -739.70, z = 29.92 },
		SpawnPoint = { x = 250.31, y = -752.05, z = 34.20, h = 68.74 }
	},
	Pound_Sandy = {
...
Config.mafia1Pounds = {
	Pound_mafiacasa = {
		PoundPoint = { x = -2674.46, y = 1300.30, z = 146.35 },
		SpawnPoint = { x = -2659.75, y = 1306.97, z = 146.22, h = 267.80 }
	},
	Pound_garageheights = {
		PoundPoint = { x = -945.95, y = -2958.02, z = 13.00 },
		SpawnPoint = { x = -951.66, y = -2966.89, z = 12.99, h = 151.40 }
...
Config.mafia2Pounds = {
	Pound_mafiacasa = {
		PoundPoint = { x = 1443.78, y = 1108.16, z = 113.36 },
		SpawnPoint = { x = 1458.95, y = 1111.40, z = 114.3, h = 267.59 }
	},
	Pound_garageheights = {
		PoundPoint = { x = -945.95, y = -2958.02, z = 13.00 },
		SpawnPoint = { x = -951.66, y = -2966.89, z = 12.99, h = 151.40 }
...
Config.mafia3Pounds = {
	Pound_mafiacasa = {
		PoundPoint = { x = -1614.38, y = 407.65, z = 107.80 },
		SpawnPoint = { x = -1613.94, y = 421.98, z = 107.80, h = 358.38 }
	},
	Pound_garageheights = {
		PoundPoint = { x = -945.95, y = -2958.02, z = 13.00 },
		SpawnPoint = { x = -951.66, y = -2966.89, z = 12.99, h = 151.40 }
...
Config.CarGarages = {
	Garage_MaxCars = {
		GaragePoint = { x = 1202.5, y = -1057.92, z = 40.91 },
		SpawnPoint = { x = 1206.35, y = -1061.31, z = 40.46, h = 119.38 },
		DeletePoint = { x = 1196.86, y = -1055.46, z = 41.44 }
	},
	Garage_CentralLS = {
		GaragePoint = { x = 213.85, y = -808.87, z = 29.727 },
		SpawnPoint = { x = 229.700, y = -800.1149, z = 29.5722, h = 157.84 },
		DeletePoint = { x = 226.76, y = -752.11, z = 29.646 }
	},
	Garage_heights = {
		GaragePoint = { x = -954.92, y = -2954.45, z = 13.00 },
		SpawnPoint = { x = -960.36, y = -2963.20, z = 13.00, h = 149.59 },
		DeletePoint = { x = -959.22, y = -2932.81, z = 13.00 }
	},
	Garage_rojo = {
		GaragePoint = { x = -900.62, y = -154.47, z = 40.88 },
		SpawnPoint = { x = -939.36, y = -166.61, z = 40.98, h = 113.16 },
		DeletePoint = { x = -920.70, y = -157.23, z = 40.88 }
	},
	Garage_Sandy = {
