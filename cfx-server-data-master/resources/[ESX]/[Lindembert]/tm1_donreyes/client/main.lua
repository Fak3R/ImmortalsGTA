...
local jobFase = 0
local NPCs = {
	{x = -453.04, y = 6197.56, z = 29.56,hash = -1922568579,rot = 0.0, top = "Don ~r~Miguel Reyes", id = 'reyes',anim = 'WORLD_HUMAN_SMOKING'},
	{x = -454.92, y = 6198.56, z = 29.56,hash = -1731772337,rot = -90.0, top = "Sr ~r~Rockefeller", id = 'rockefeller',anim = 'world_human_leaning'},
	{x = -452.64, y = 6200.52, z = 29.56,hash = 919005580,rot = 145.0, top = "Cp ~r~Zuckerberg", id = 'marcos',anim = 'WORLD_HUMAN_PARTYING'},
