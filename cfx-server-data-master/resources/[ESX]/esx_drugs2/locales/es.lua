Locales['es'] = {
	...
	['press_collect_meth'] = 'Presiona ~INPUT_CONTEXT~ para recoger ingredientes de Metanfetamina',
	['press_process_meth'] = 'Presiona ~INPUT_CONTEXT~ para cocinar la Metanfetamina',
	...
	['inv_full_meth'] = 'No puedes recoger mas Metanfetamina, tu inventario está ~r~lleno~s~',
	['not_enough_meth'] = 'No tienes suficientes ingredientes para ~r~fabricar~s~ mas Metanfetamina',
	['sold_one_meth'] = 'Has vendido ~g~1 Bote de Metanfetamina~s~',
