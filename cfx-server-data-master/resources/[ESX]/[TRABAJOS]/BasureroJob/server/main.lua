...
AddEventHandler('esx_garbagejob:pay', function(amount)
	...
	--TriggerClientEvent('esx:showNotification', source, '~s~Recibiste~g~ '..payamount..' ~s~por esta parada~s~!')
	TriggerClientEvent('mythic_notify:client:SendAlert', source, { type = 'success', text = 'Recibiste ' .. payamount .. '$ por esta parada!',length = 8000})
  
   local randomexp = math.random(50,99)
