...
function OpenBuyLicenseMenu(zone)
  ...
  ESX.UI.Menu.Open(
    ...
    local totalexp   = exports['SistemaNiveles']:Exp_XNL_GetCurrentPlayerXP(PlayerId())
    local nivelactual = exports['SistemaNiveles']:Exp_XNL_GetCurrentPlayerLevel(totalexp)
      ...
      if data.current.value == 'yes' then
        ...
        ESX.ShowNotification('~r~Necesitas Nivel 10 para comprar licencia y acceder a la tienda~s~')
          end
...
--table.insert(elements, {label = '---  Municion  ---', value = nil})
