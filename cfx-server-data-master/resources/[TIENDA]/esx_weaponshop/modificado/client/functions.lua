...
GetWeaponMenuElements = function(weaponModel, weaponElement)
    local ammoPrice = Config.AmmoTypes[GetPedAmmoTypeFromWeapon(cachedData["ped"], GetHashKey(Config.Weapons[weaponElement and weaponElement["value"] + 1 or 1]["model"]))] * 2
    ...
    local menuElements = {
        ...
        {
            ["name"] = "ammo",
            ["label"] = "Comprar 100x ammo $" .. ammoPrice,
            ["price"] = ammoPrice
        }
    }
