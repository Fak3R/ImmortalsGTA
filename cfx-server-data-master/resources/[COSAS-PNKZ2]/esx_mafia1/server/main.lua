...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'yeezuus', Config.MaxInService)
end

-- TriggerEvent('esx_phone:registerNumber', 'yeezuus', _U('alert_mafia'), true, true)
TriggerEvent('esx_society:registerSociety', 'yeezuus', 'yeezuus', 'society_yeezuus', 'society_yeezuus', 'society_yeezuus', {type = 'public'})
...
AddEventHandler('esx_mafiajob:putStockItems', function(itemName, count)
  ...
  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_yeezuus', function(inventory)
...
ESX.RegisterServerCallback('esx_mafiajob:getArmoryWeapons', function(source, cb)
  ...
  TriggerEvent('esx_datastore:getSharedDataStore', 'society_yeezuus', function(store)
...
ESX.RegisterServerCallback('esx_mafiajob:buy', function(source, cb, amount)
  ...
  TriggerEvent('esx_addonaccount:getSharedAccount', 'society_yeezuus', function(account)
