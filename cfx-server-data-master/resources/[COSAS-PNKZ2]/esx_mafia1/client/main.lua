...
function OpenCloakroomMenu()
  ...
  local elements = {
    ...
    {label = _U('yeezuus_wear'), value = 'yeezuus_wear'}
  }
  ...
  if Config.EnableNonFreemodePeds then
    ...
    ESX.UI.Menu.Open(
      ...
      if data.current.value == 'yeezuus_wear' then
...
function OpenArmoryMenu(station)
  ...
  if Config.EnableArmoryManagement then
    ...
    for i=1, #Config.MafiaStations1[station].AuthorizedWeapons, 1 do
      local weapon = Config.MafiaStations1[station].AuthorizedWeapons[i]
...
function OpenVehicleSpawnerMenu(station, partNum)
  ...
  local vehicles = Config.MafiaStations1[station].Vehicles
  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'yeezuus', vehicleProps)
    ...
    for i=1, #Config.MafiaStations1[station].AuthorizedVehicles, 1 do
      local vehicle = Config.MafiaStations1[station].AuthorizedVehicles[i]
...
function OpenMafiaActionsMenu()
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'yeezuus_actions',
    {
      title    = 'yeezuus',
      align    = 'top-left',
      elements = {
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if Config.EnablePlayerManagement then
          TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_yeezuus', _U('fine_total') .. label, amount)
        else
...
AddEventHandler('esx_mafiajob:hasEnteredMarker', function(station, part, partNum)
  ...
  if part == 'HelicopterSpawner' then
    ...
    local helicopters = Config.MafiaStations1[station].Helicopters
...
Citizen.CreateThread(function()
  ...
  for k,v in pairs(Config.MafiaStations1) do
...
Citizen.CreateThread(function()
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'yeezuus' then
      ...
      for k,v in pairs(Config.MafiaStations1) do
        ...
        if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.name == 'yeezuus' and PlayerData.job.grade_name == 'boss' then
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'yeezuus' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'yeezuus', vehicleProps)
            ...
            then
              TriggerServerEvent('esx_service:disableService', 'yeezuus')
            end
        ...
        if CurrentAction == 'menu_boss_actions' then
          ...
          TriggerEvent('esx_society:openBossMenu', 'yeezuus', function(data, menu)
   ...
   if IsControlPressed(0,  Keys['F6']) and PlayerData.job ~= nil and PlayerData.job.name == 'yeezuus' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'mafia_actions') and (GetGameTimer() - GUI.Time) > 150 then
