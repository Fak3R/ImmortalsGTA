...
local grandmasLocationx = 260.59  -- coords as a float ex 112.3
local grandmasLocationy = -747.44 -- coords as a float ex 112.3
local grandmasLocationz = 31.14 -- coords as a float ex 112.3
...
AddEventHandler('esx_grandmas:hasEnteredMarker', function(zone)
	...
	CurrentActionMsg  = 'Presiona [E] para comenzar a reanimarlo | 5000$.'
