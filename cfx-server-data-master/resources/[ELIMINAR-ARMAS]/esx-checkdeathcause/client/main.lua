  ...
  function Start(ped)
	  ...
	  while checking do
		  ...
		  if distance < 2.0 then
			  DrawText3D(x,y,z, 'Presiona [~g~E~s~] para ver al herido', 0.4)
  ...
  function OpenDeathMenu(player)
	  ...
	  table.insert(elements, {label = 'Intenta identificar la causa de la muerte', value = 'deathcause'})
	  table.insert(elements, {label = 'Intenta identificar donde ocurrio el daño', value = 'damage'})
	  ...
	  function(data, menu)
		  ...
		  if ac == 'damage' then
			  ...
			  if success then
				  ...
				  Notify('No se pudo identificar el daño.')
			  end
		  end
